...
export default function Footer() {
  ...
  <div className="grid-flow-col gap-4 md:place-self-center md:justify-self-end">
    <a target='_blank'><SiDevpost className="fill-accent" size={32}/></a>
   <a target='_blank'><SiGithub className='fill-accent' size={32}/> </a> 
   <a target='_blank'><SiLinkedin className='fill-accent' size={32}/> </a>
  </div>
</footer>
    </div>
  )
