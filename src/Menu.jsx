  ...
  return (
    <header className="h-10 mb-4">
      <button className="absolute top-4 left-4 z-[100]" onClick={toggleMenu}>
        {menuActive ? <GiCrossMark className="fill-accent" size={32} /> : <GiHamburgerMenu className="fill-accent" size={32} />}
      </button>
      <img src="./src/assets/anarchy.svg" alt="" className="h-8 top-4 right-4 absolute z-[1000] bg-accent" />
      { menuActive && <div id="menu" className="h-screen z-[1000] flex items-center animate__animated animate__fadeIn bg-primary opacity-70 backdrop-blur-lg">
        <div
          id="menu-items"
